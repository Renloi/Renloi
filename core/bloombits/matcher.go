...
import (
	...
	"github.com/renloi/renloi/common/bitutil"
...
// that address/topic, and binary AND-ing those vectors torenloier.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them torenloier
				var orVector []byte
...
// the requested retrieval queue to be serviced torenloier with other sessions.
//
