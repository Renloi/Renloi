...
import (
	...
	"github.com/renloi/renloi/common/prque"
	"github.com/renloi/renloi/consensus"
	"github.com/renloi/renloi/core/rawdb"
	"github.com/renloi/renloi/core/state"
	"github.com/renloi/renloi/core/state/snapshot"
...
type CacheConfig struct {
	...
	TrieDirtyDisabled   bool          // Whether to disable trie write caching and GC altorenloier (archive node)
...
func (bc *BlockChain) setHeadBeyondRoot(head uint64, root common.Hash, repair bool) (uint64, error) {
	...
	// touching the header chain altorenloier, unless the freezer is broken
	if repair {
...
// it's not checked in the Renloi side anymore.
