...
import (
	...
	tracers2 "github.com/renloi/renloi/eth/tracers"
	"github.com/renloi/renloi/eth/tracers/js/internal/tracers"
...
// init retrieves the JavaScript transaction tracers included in renloi.
func init() {
