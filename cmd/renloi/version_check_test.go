...
func TestRenloiPubKeysParseable(t *testing.T) {
	for _, pubkey := range renloiPubKeys {
...
func TestKeyID(t *testing.T) {
	...
	tests := []struct {
		...
		{"@holiman key", args{id: extractKeyId(renloiPubKeys[0])}, "FB1D084D39BAEC24"},
		{"second key", args{id: extractKeyId(renloiPubKeys[1])}, "138B1CA303E51687"},
		{"third key", args{id: extractKeyId(renloiPubKeys[2])}, "FD9813B2D2098484"},
	}
