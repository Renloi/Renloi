...
func (g *renloirpc) killAndWait() {
	g.renloi.Kill()
	g.renloi.WaitExit()
}

func (g *renloirpc) callRPC(result interface{}, method string, args ...interface{}) {
	if err := g.rpc.Call(&result, method, args...); err != nil {
		g.renloi.Fatalf("callRPC %v: %v", method, err)
	}
}

func (g *renloirpc) addPeer(peer *renloirpc) {
...
func (g *renloirpc) getNodeInfo() *p2p.NodeInfo {
	if g.nodeInfo != nil {
		return g.nodeInfo
	}
...
func startRenloiWithIpc(t *testing.T, name string, args ...string) *renloirpc {
...
func startLightServer(t *testing.T) *renloirpc {
...
func startClient(t *testing.T, name string) *renloirpc {
	datadir := initRenloi(t)
