...
import (
	...
	"github.com/renloi/renloi/console"
...
See https://renloi.renloi.org/docs/interface/javascript-console.`,
	}
...
JavaScript API. See https://renloi.renloi.org/docs/interface/javascript-console`,
	}
)
...
func localConsole(ctx *cli.Context) error {
	...
	if err != nil {
		return fmt.Errorf("Failed to attach to the inproc renloi: %v", err)
	}
