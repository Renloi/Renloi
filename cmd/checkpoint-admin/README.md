...
There are several hardcoded checkpoints in the [source code](https://github.com/renloi/renloi/blob/master/params/config.go#L38) of the Renloi project. These checkpoints are updated by Renloi developers when new versions of software are released. Because light client users trust Renloi developers to some extent, hardcoded checkpoints in the code can also be considered correct.
...
```shell
go get github.com/renloi/renloi/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/renloi/renloi/blob/master/params/config.go#L251).*
