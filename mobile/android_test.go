...
public class AndroidTest extends InstrumentationTestCase {
	...
	// signatures too. Regression test for renloi issue #14599.
...
func TestAndroid(t *testing.T) {
	// Skip tests on Windows altorenloier
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/renloi/renloi/mobile")
