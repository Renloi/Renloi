...
func (p *SecretsInit) DefineFlags() {
	...
	p.FlagMap["data-dir"] = helper.FlagDescriptor{
		Description: "Sets the directory for the Renloi data if the local FS is used",
		Arguments: []string{
			"DATA_DIRECTORY",
		},
...
func (p *SecretsInit) GetHelperText() string {
	return "Initializes private keys for the Renloi (Validator + Networking) to the specified Secrets Manager"
}
