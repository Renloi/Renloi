...
import (
	...
	helperFlags "github.com/Renloi/Renloi/helper/flags"
...
func (c *GenesisCommand) DefineFlags() {
	...
	c.FlagMap["dir"] = helper.FlagDescriptor{
		Description: fmt.Sprintf("Sets the directory for the Renloi genesis data. Default: %s", helper.GenesisFileName),
		Arguments: []string{
			"DIRECTORY",
		},
